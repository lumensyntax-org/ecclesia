...
cross_domains: [economy, spirit, shadow, mirror, law, civilization, chemistry]
---
...
| Property | Phase 1 (reflecting) | Phase 4 (extracting) |
|----------|---------------------|---------------------|
| **Alignment** | Purpose (facilitate exchange) matches action (money flows) | Purpose claimed (serve customers) contradicts action (extract their data) |
| **Proportion** | Profit proportional to value created | Extraction without limit — attention harvested 24/7 |
| **Honesty** | Prices reflect real supply and demand | Prices manipulated, value fabricated, the user does not know they are the product |
| **Humility** | Money operates within its scope (medium of exchange) | Money claims to BE value, corporations claim to be persons, algorithms claim authority over human choice |
| **Non-fabrication** | Money represents what exists | Derivatives fabricate value; CDOs fabricate safety ratings; crypto ponzis fabricate returns |
...
- [[The Anointing and the Mirror]] — the parent entry; capital as reflection/retention is the economic expression of the anointing framework
- [[Invention of Money]] — money as technology of trust; when trust breaks, money fails
- [[Inflation as Fabrication]] — Phase 3: fabricating value that does not exist
- [[Bubbles and Crashes]] — the cycle of fabrication and correction
- [[2008 Financial Crisis]] — Phase 3 in action: cascading property violations
...
- [[Ostrom Governing the Commons]] — structural governance that maintains reflection without requiring centralized control
- [[Narcissus]] — the myth of the reflection mistaken for the source; the financial system that mistakes its instruments for real value
- [[Propaganda]] — the economic marketing machine: reflective surfaces designed to retain attention
- [[Corruption]] — the instrument of public service claiming private benefit; Phase 2 in governance
