...
**Source**: Kahneman and Tversky, "Prospect Theory," Econometrica, 1979; Thaler (Nobel 2017)
**Context**: Demonstrated systematic deviations from rational-agent models. Loss aversion: losses hurt roughly twice as much as equivalent gains. Framing effects: "90% survival" and "10% mortality" produce different choices despite logical identity. Anchoring: exposure to a number biases subsequent estimates. Thaler extended into the endowment effect and mental accounting. Kahneman received the 2002 Nobel.
