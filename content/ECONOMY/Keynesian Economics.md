...
**Context**: Keynes argued classical economics was wrong to assume markets automatically return to full employment. During recessions, private spending collapses, and the rational individual response (save more, spend less) makes the collective problem worse -- the "paradox of thrift." Government should spend counter-cyclically: increase during recessions, reduce during booms. The New Deal and postwar economic management were influenced by Keynesian ideas.
