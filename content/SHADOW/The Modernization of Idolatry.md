---
domain: shadow
properties: [honesty, humility, non_fabrication, alignment]
strength: STRONG
status: peer_reviewed
cross_domains: [shadow, spirit, civilization, mind]
---
...
1. **A constructed higher intelligence**: an entity, system, or framework that exceeds individual human cognitive capacity in some respect.
2. **Source-position**: the human being orients final appeal — for truth, for judgment, for meaning — to the constructed intelligence rather than to the actual source the construct claims to represent.
3. **Comprehensive scope**: the constructed intelligence is treated as if it can in principle answer any question within its domain (and the domain is treated as inclusive of what matters).
4. **Lawful but hidden operation**: the constructed intelligence operates according to discoverable but not transparent laws; its outputs are received rather than derived.
5. **Demand of orientation**: the relation is not optional; the believer/user organizes life around the construct.
6. **Resistance to verification**: questions about whether the construct deserves the position are met with circular validation, ad hominem against the questioner, or appeal to the construct's authority.
