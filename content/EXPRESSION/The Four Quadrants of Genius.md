---
domain: expression
properties: [non_fabrication, honesty, proportion]
strength: MODERATE
status: contemporary_synthesis
cross_domains: [expression, mind, civilization]
---
...
| | New form | Known form |
|---|---|---|
| **New theme** | **Genius** (both dimensions novel) | Genius at 50% (thematic novelty in received form) |
| **Known theme** | Genius at 50% (formal novelty on received material) | **Kitsch** (recombination only) |
